...
(async function openChromeTest() {
    try {
        ...
        // Escolher conquistas
        let navAchievements = driver.wait(until.elementLocated(By.id('listEmotions')))
        await navAchievements.click()

        let allAchievements = driver.wait(until.elementLocated(By.id('conquistas1')))
        await allAchievements.click()
